...
<section class="container">
  ...
  <div class="card bg-light mt-3">
    <div class="card-header bg-light">
      <div class="row">
        <div class="col-8 text-left">컴퓨터&nbsp;<small>김재혁</small></div>
    ...
    <div class="card-body">
      <h5 calss="card-title">
        정말 좋은 강의에요.&nbsp;<small>(2024년 가을학기)</small>
      </h5>
      <p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운건 없는것 같지만 학점도 잘나오고 너무 좋은것 같아요</p>
      <div class="row">
